...
int main()
{
    ...
    for (int i = 0; i < sizeA; i++)         //определяем минимально возможную размерность третьего массива
    {
    ...
    for (int i = 0; i < sizeA; i++)         //заполняем результирующий массив значениями по условию задачи
    {
