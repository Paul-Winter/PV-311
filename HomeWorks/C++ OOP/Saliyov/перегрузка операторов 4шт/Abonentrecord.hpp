...
public:
    ...
    ~Abonentrecord();
    bool operator== (const Abonentrecord &f);
    bool operator!= (const Abonentrecord &f);
    bool operator< (const Abonentrecord &f);
    bool operator> (const Abonentrecord &f);
    ...
    const char* const getinformation() const;
    uint64_t getmobNumber() const;
    uint64_t gethomeNumber() const;
    uint64_t getworkNumber() const;
    void displayAbonent();
