...
explicit Abonent::Abonent(const Abonent &copy) : Abonenet(copy.AbonentName,copy.Information,copy.HomeNumber,copy.WorkNumber)
{

}

Abonent &Abonent::operator=(const Abonent &s){
    delete [] AbonentName;
    delete [] Information;
    this->AbonentName=new char[AbonentName_size];
    this->Information=new char[Infotmation_size];
    strcpy_s(this->AbonentName,AbonentName_size,s.AbonentName);
    strcpy_s(this->Information,Information_size,s.Information);
    this->WorkNumber=s.WorkNumber;
    this->HomeNumber=s.HomeNumber;
    return this*;
}
